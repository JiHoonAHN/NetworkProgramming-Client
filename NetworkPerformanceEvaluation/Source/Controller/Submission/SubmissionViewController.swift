...
class SubmissionViewController : BaseVc{
    ...
    private lazy var stackView = UIStackView(arrangedSubviews: [subjectTf,lectureTf]).then{
        $0.spacing = 24
